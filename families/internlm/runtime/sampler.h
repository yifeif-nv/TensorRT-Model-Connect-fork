...
/// Build InternlmSamplingParams from TextGenerationConfig fields.
/// Forward-declared here; defined in sampler.cpp alongside the factory.
struct TextGenerationConfig; // defined in trtmc/task.h

InternlmSamplingParams internlm_sampling_params_from_config(const TextGenerationConfig& cfg,
