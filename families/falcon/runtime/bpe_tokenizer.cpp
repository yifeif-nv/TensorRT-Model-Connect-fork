...
enum class Variant { kFalcon, kQwen3, kBloom, kDeepSeek, kClip };
...
class BpeTokenizer final : public ITokenizer {
  ...
  private:
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kFalcon;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kFalcon;
