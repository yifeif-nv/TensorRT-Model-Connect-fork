...
enum class Variant { kQwen38, kQwen3, kBloom, kDeepSeek, kClip };
...
class BpeTokenizer final : public ITokenizer {
  ...
  private:
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kQwen38;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kQwen38;
