...
enum class Variant { kGranite, kQwen3, kBloom, kDeepSeek, kClip };
  ...
  private:
    ...
    static pretok::Variant classify_clip_split(const nlohmann::json& split) {
        ...
        if (behavior == "Isolated" && invert)
            return pretok::Variant::kGranite;
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kGranite;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kGranite;
