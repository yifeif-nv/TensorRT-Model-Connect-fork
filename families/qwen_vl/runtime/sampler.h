...
/// Build QwenVlSamplingParams from TextGenerationConfig fields.
...
qwen_vl_sampling_params_from_config(const TextGenerationConfig& cfg,
                                    const std::vector<int32_t>& default_eos_token_ids);
QwenVlSamplingParams qwen_vl_sampling_params_from_config(const TextGenerationConfig& cfg,
