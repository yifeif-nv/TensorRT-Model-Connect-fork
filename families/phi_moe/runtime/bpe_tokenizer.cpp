...
enum class Variant { kPhiMoe, kQwen3, kBloom, kDeepSeek, kClip };
...
class BpeTokenizer final : public ITokenizer {
  ...
  private:
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kPhiMoe;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kPhiMoe;
