...
enum class Variant { kStarcoder2, kQwen3, kBloom, kDeepSeek, kClip };
  ...
  private:
    ...
    static pretok::Variant classify_clip_split(const nlohmann::json& split) {
        ...
        if (behavior == "Isolated" && invert)
            return pretok::Variant::kStarcoder2;
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kStarcoder2;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kStarcoder2;
