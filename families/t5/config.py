...
class ModelConfig:
    ...
    def from_json(text: str) -> ModelConfig:
        ...
        return ModelConfig(
            ...
            bos_token_id=-1 if d.get("bos_token_id") is None else int(d["bos_token_id"]),
            eos_token_id=-1 if d.get("eos_token_id") is None else int(d["eos_token_id"]),
            pad_token_id=-1 if d.get("pad_token_id") is None else int(d["pad_token_id"]),
