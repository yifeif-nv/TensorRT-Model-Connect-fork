...
enum class Variant { kLfm2, kQwen3, kBloom, kDeepSeek, kClip };
...
class BpeTokenizer final : public ITokenizer {
  ...
  private:
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kLfm2;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kLfm2;
