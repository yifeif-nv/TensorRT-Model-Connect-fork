...
enum class Variant { kGemma, kQwen3, kBloom, kDeepSeek, kClip };
...
class BpeTokenizer final : public ITokenizer {
  ...
  private:
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kGemma;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kGemma;
