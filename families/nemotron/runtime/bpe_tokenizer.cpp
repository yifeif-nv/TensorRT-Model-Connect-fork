...
enum class Variant { kNemotron, kQwen3, kBloom, kDeepSeek, kClip };
  ...
  private:
    ...
    static pretok::Variant classify_clip_split(const nlohmann::json& split) {
        ...
        if (behavior == "Isolated" && invert)
            return pretok::Variant::kNemotron;
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kNemotron;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kNemotron;
