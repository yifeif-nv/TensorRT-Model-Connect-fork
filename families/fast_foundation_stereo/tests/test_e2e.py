...
def test_middlebury_q_task_accuracy_e2e(request, tmp_path: Path) -> None:
    ...
    if not configured:
        pytest.skip(f"Middlebury-Q E2E requires {MIDDLEBURY_DATASET_ENV}")
    ...
    thresholds = _thresholds("fast-foundation-stereo")
    statistics = []
