...
enum class Variant { kStablelm, kQwen3, kBloom, kDeepSeek, kClip };
  ...
  private:
    ...
    static pretok::Variant classify_clip_split(const nlohmann::json& split) {
        ...
        if (behavior == "Isolated" && invert)
            return pretok::Variant::kStablelm;
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kStablelm;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kStablelm;
