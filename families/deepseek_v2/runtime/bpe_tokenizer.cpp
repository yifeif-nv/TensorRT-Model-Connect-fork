...
enum class Variant { kDeepseekV2, kQwen3, kBloom, kDeepSeek, kClip };
  ...
  private:
    ...
    static pretok::Variant classify_clip_split(const nlohmann::json& split) {
        ...
        if (behavior == "Isolated" && invert)
            return pretok::Variant::kDeepseekV2;
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kDeepseekV2;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kDeepseekV2;
