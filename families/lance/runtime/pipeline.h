...
// Composes: vision_encoder ITrtModule + text_decoder ITrtModule + LanceKvCache.

#include "families/lance/runtime/image_preprocessor.h"
#include "families/lance/runtime/inference_state.h"
#include "families/lance/runtime/kv_cache.h"
#include "families/lance/runtime/sampler.h"
...
class LancePipeline final : public ITextGeneration, public IVisionLanguageGeneration {
  public:
    ...
    LancePipeline(std::unique_ptr<ITrtModule> text_decoder,
