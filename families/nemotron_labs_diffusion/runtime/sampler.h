...
/// Build NemotronLabsDiffusionSamplingParams from TextGenerationConfig fields.
...
nemotron_labs_diffusion_sampling_params_from_config(const TextGenerationConfig& cfg,
