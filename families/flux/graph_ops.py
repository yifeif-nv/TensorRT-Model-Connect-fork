...
def add_layer_norm_no_affine(
    ...
    with all-ones gamma and all-zeros beta. This family-owned helper
...
def add_attention_core(
    ...
    # Ordinary BF16/FP16 attention may be decomposed. Quantized IAttention
    # stays fused to avoid lowering a very large FP8 primitive graph
