...
enum class Variant { kGlm, kQwen3, kBloom, kDeepSeek, kClip };
...
class BpeTokenizer final : public ITokenizer {
  ...
  private:
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kGlm;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kGlm;
