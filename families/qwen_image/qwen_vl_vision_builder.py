...
def build_qwen_vl_vision_engine(
    ...
    *,
    ...
    Args:
        ...
        fixed_image_size: Default square image height and width.
    ...
    # Use intermediate_size when present, otherwise derive it from mlp_ratio.
    ...
    if merger_fc2_w is not None:
        ...
        # Otherwise infer the value from config.
    ...
    for layer_idx in range(num_layers):
        ...
        if up_w is not None:
            ...
            # GELU fc1/fc2 checkpoint layout
