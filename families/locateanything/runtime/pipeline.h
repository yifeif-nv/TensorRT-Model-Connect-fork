...
// Composes: vision_encoder ITrtModule + text_decoder ITrtModule + LocateanythingKvCache.

#include "families/locateanything/runtime/image_preprocessor.h"
#include "families/locateanything/runtime/inference_state.h"
#include "families/locateanything/runtime/kv_cache.h"
#include "families/locateanything/runtime/sampler.h"
#include "families/locateanything/runtime/tokenizer.h"
...
class LocateAnythingPipeline final : public ITextGeneration, public IVisionLanguageGeneration {
  public:
    ...
    LocateAnythingPipeline(std::unique_ptr<ITrtModule> text_decoder,
