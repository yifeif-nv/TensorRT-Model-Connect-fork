...
enum class Variant { kMamba, kQwen3, kBloom, kDeepSeek, kClip };
...
class BpeTokenizer final : public ITokenizer {
  ...
  private:
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kMamba;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kMamba;
