...
enum class Variant { kXglm, kQwen3, kBloom, kDeepSeek, kClip };
...
class BpeTokenizer final : public ITokenizer {
  ...
  private:
    ...
    void detect_pre_tokenizer(const nlohmann::json& j) {
        ...
        mPreTokenizerVariant = pretok::Variant::kXglm;
    ...
    pretok::Variant mPreTokenizerVariant = pretok::Variant::kXglm;
