...
// Composes: vision_encoder ITrtModule + text_decoder ITrtModule + InternvlKvCache.

#include "families/internvl/runtime/image_preprocessor.h"
#include "families/internvl/runtime/inference_state.h"
#include "families/internvl/runtime/kv_cache.h"
#include "families/internvl/runtime/sampler.h"
#include "families/internvl/runtime/tokenizer.h"
...
class InternVlPipeline final : public ITextGeneration, public IVisionLanguageGeneration {
  public:
    ...
    InternVlPipeline(std::unique_ptr<ITrtModule> text_decoder,
